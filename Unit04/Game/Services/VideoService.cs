...
namespace Unit04.Game.Services
{
    ...
    public class VideoService
    {
        ...
        public void DrawActor(Actor actor)
        {
            ...
            string score_print = actor.GetText_finalscore();
            int x = actor.GetPosition().GetX();
            int y = actor.GetPosition().GetY();
            int x1 = actor.GetPosition().GetX();
            int y1 = actor.GetPosition().GetY()+10;
            int fontSize = actor.GetFontSize();
            Casting.Color c = actor.GetColor();
            Raylib_cs.Color color = ToRaylibColor(c);
            Raylib.DrawText(score_print, x1, y1, fontSize, color);
            Raylib.DrawText(text, x, y, fontSize, color);
        }
        // public double getTime(){
        //     double x = Raylib.GetTime();
        //     return x;
        // }
        // /// <summary>
